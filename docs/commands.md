...
- **Quote of the week**: Triggered by a scheduled (`schedule` or `workflow_dispatch`) GitHub Action. Generates a short uplifting sentence, rewrites the quote line in the repo's `README.md`, and commits. Not a slash command - triggered by event type.
